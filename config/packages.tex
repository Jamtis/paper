% default \include messes up \ref{fig:...}
% must come before thmtools
\usepackage{newclude}
...
\usepackage{hyperref}
\usepackage[capitalize,nameinlink]{cleveref} % load after amsmath
...
% \usepackage{ifdraft}
% \usepackage{ifluatex}
%\usepackage{mfirstuc} % upper case first letter