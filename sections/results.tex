...
\begin{proof}
    ...
    The sel-IND-CCKL PKE scheme is a marginally modified version of the IND-CCA secure KEM of~\textcite{EC:HofKil09}.
    \begin{sitemize}
    ...
    \begin{bralign}
        ...
        \negl\parr{\secpar}
    \end{bralign}
    Now, let's prove sel-IND-CCKL security of our scheme.
    \begin{hybrids}
        \item This is the original sel-IND-CCKL with bit \(b = 0\), i.e., the challenge key \(\kappa = \kappa^*\) is the actual key.
...
\begin{theorem}
    Let \(\PKE' = \parr{\Gen',\Enc',\Dec',\Punct'}\) be a prefectly correct \(\varepsilon'_{\textsf{IND-CCKL}}\)-ad-IND-CCKL secure cpPKE with binary message space \(M'_\secpar \coloneq \parc{0^\secpar,1^\secpar}\).
