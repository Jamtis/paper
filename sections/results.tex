...
\begin{proof}
    ...
    \begin{bralign}
        ...
        \\
        &=
        1 - \Pr{\Dec\parr{\sk_1\pars{t'_1},c_1} = \bot}^{\ihat-1} \Pr{\Dec\parr{\sk_\ihat\pars{t'_\ihat},c_\ihat} = m}
        \marginnote{indepdence of events}
        \\
        &\leq
        1 - \parr{1 - \alpha'_{\textsf{DE}}\parr{\secpar}}^{\ihat-1} \parr{1 - \alpha'_{\textsf{PK}}\parr{\secpar}}
        \\
        &\leq
        1 - \parr{1 - 1.1/\secpar} \parr{1 - 1/\secpar^2}
        \\
        &\leq
        2/\secpar
        \ .
