...
\begin{proof}
    ...
    \begin{bralign}
        ...
        +
        1/4
        \marginnote{\(\pk_i\) is independent of \(\hat{t}_i\) by definition of \(M\)-ad-IND-CTKL game, hence \(\Pr{\hat{t}_i = t^*_i} = 1/2\)}
        \\
        &=
...
\begin{proof}
    ...
    \begin{bralign}
        ...
        &=
        \Pr{
            \forall i \in \parc{1,...,\secpar} : \Dec'\parr{\sk'_i\pars{c'_i},c_i} = m^i
        }
        \\
        &=
        1
        ...
        1
        -
        \sum_{i=1}^{\secpar} \Pr{\Dec'\parr{\sk'_i\pars{c'_i},c_i} \neq m^i}
        \\
        &\geq
